...
DOCUMENTATION = r'''
---
module: nvidia.infra_controller.measured_boot_trusted_profile
short_description: Manage Measured Boot Trusted Profile resources
description:
...
- name: Create a Measured Boot Trusted Profile
  nvidia.infra_controller.measured_boot_trusted_profile:
    ...
    org: "{{ org }}"
    state: present
    name: "my-measured-boot-trusted-profile"
...
RESOURCE_CONFIG = {
    ...
    'id_param': 'id',
    'name_field': None,
    'create_schema_fields': ['site_id', 'profile_id', 'approval_type', 'pcr_registers', 'comments'],
